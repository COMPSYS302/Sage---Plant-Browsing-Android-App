                ...
                if (showDelete) {
                    ...
                    deleteButton.setOnClickListener(v -> {
                        ...
                        if (pos != RecyclerView.NO_POSITION) {
                            ...
                            if (currentUser == null) {
                                Toast.makeText(itemView.getContext(), "User not logged in", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            String email = currentUser.getEmail();

                            // Shake animation - Animation logic generated by Chatgpt
                            Animation shrink_fade = AnimationUtils.loadAnimation(itemView.getContext(), R.anim.shrink_fade);
                            shrink_fade.setFillAfter(true);
                            shrink_fade.setAnimationListener(new Animation.AnimationListener() {
                                @Override public void onAnimationStart(Animation animation) { }
                                @Override
                                public void onAnimationEnd(Animation animation) {
                                    // Remove from favourites
                                    firestoreManager.deleteFavourite(plant.getPlantid(), email, unused -> {
                            ...
                            itemView.startAnimation(shrink_fade);
                        }
                    });
                }
            }
